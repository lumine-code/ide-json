...
const jsonSettings = () => ({
  // The client router owns grammar-scoped feature switches. Keeping these
  // server capabilities live preserves scoped true overrides of a false base.
...
module.exports = {
  consumeIdeClient(service) {
    const adapter = {
      ...
      restartKeyPaths: ["ide-json.serverPath"],
      managedServer,
